...
it:{
  ...
  wParP:"Le simulazioni partono da due valori scelti da noi: una massa del payload di <strong>1,5 kg</strong> e una velocità di salita di <strong>5 m/s</strong>. Da lì il calcolo ricava tutto il resto: <strong>4,5 m³</strong> di elio, uno scoppio a <strong>37,7 km</strong>, un arrivo al suolo a <strong>4,7 m/s</strong> e circa tre ore di volo. Nessuno dei due valori di partenza è definitivo — la massa si fisserà con la pesata in fase di assemblaggio, la velocità di salita si deciderà anche in base alle condizioni meteorologiche del giorno — quindi tutto quello che ne discende, quota di scoppio compresa, è soggetto a variazioni. Per questo nel resto del sito questi numeri sono arrotondati.",
  ...
  ph6t:"Lo scoppio",
  ph6p:"Il lattice ha un limite di allungamento, e a un certo punto lo raggiunge: è la <strong>quota di scoppio</strong>, quella che la scala qui accanto segna. Da quell'istante la sonda comincia a cadere.",
  ph7t:"La discesa",
...
es:{
  ...
  wParP:"Las simulaciones parten de dos valores elegidos por nosotros: una masa de la carga útil de <strong>1,5 kg</strong> y una velocidad de ascenso de <strong>5 m/s</strong>. De ahí el cálculo saca todo lo demás: <strong>4,5 m³</strong> de helio, un reventado a <strong>37,7 km</strong>, una llegada al suelo a <strong>4,7 m/s</strong> y unas tres horas de vuelo. Ninguno de los dos valores de partida es definitivo — la masa se fijará con el pesaje en la etapa de armado, la velocidad de ascenso se decidirá también según las condiciones meteorológicas del día — así que todo lo que se deriva de ellos, la altura de reventado incluida, está sujeto a variaciones. Por eso en el resto del sitio estos números están redondeados.",
  ...
  ph6t:"El estallido",
  ph6p:"El látex tiene un límite de estiramiento, y en algún momento lo alcanza: es la <strong>altura de reventado</strong>, la que marca la escala de al lado. Desde ese instante la sonda empieza a caer.",
  ph7t:"El descenso",
...
en:{
  ...
  wParP:"The simulations start from two values we chose: a payload mass of <strong>1.5 kg</strong> and an ascent rate of <strong>5 m/s</strong>. Everything else follows from there: <strong>4.5 m³</strong> of helium, a burst at <strong>37.7 km</strong>, a landing at <strong>4.7 m/s</strong> and about three hours of flight. Neither starting value is final — the mass will be settled by the weigh-in at assembly, and the ascent rate will also depend on the weather on the day — so everything that follows from them, burst altitude included, is subject to change. That is why these numbers are rounded elsewhere on the site.",
  ...
  wA0P:"The whole calculation starts from how much the probe weighs, and today that figure is an estimate: the parts are not all built or weighed yet. We kept it deliberately high, and that has a definite consequence — an overestimated mass calls for more helium, and more helium means a lower burst. So the predicted altitude is, if anything, a cautious one: at the real weight the flight should reach at least that high.",
  ...
  ph6t:"The burst",
  ph6p:"Latex has a stretching limit, and at some point it reaches it: that is the <strong>burst altitude</strong>, the one the scale beside it shows. From that instant the probe begins to fall.",
  ph7t:"The descent",
  ...
  wMod4:"<strong>How it falls.</strong> A parachute brakes in proportion to the density of the air it meets. High up, where the air is two hundred times thinner, it brakes very little and the descent is fast; lower down the air thickens and the probe slows progressively. With our 1.2 m parachute it reaches the ground at a little under 5 m/s. The descent takes a little under an hour and does not depend on how much helium was used, whereas the ascent does: that is why the whole trade-off is played out on the way up.",
