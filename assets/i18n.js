...
it:{
  ...
  wSimP1:"Abbiamo simulato un lancio al giorno dal <strong>10 settembre all'8 novembre</strong>, per cinque anni: {years}. Sessanta date per anno, ripetute da due punti di partenza — <strong>Durazno</strong> e <strong>Mercedes</strong> — per un totale di <strong>600 voli simulati</strong>, trecento per sito.",
  wSimP2:"Ogni punto sulla mappa è l'atterraggio di uno di questi voli, e le spunte in alto a destra accendono e spengono i tre periodi. Le ellissi però sono disegnate su uno solo, il <strong>10 settembre – 9 ottobre</strong>, quello che contiene la data prevista di lancio: partendo dallo stesso luogo in quel periodo, un nuovo lancio avrebbe circa il <strong>50 % di probabilità di cadere nell'ellisse piccola</strong> e il <strong>90 % nella grande</strong>.",
  wSimP3:"Sugli altri due periodi le ellissi non ci sono, e non è una dimenticanza. Un'ellisse non è un disegno ma un riassunto statistico, e presuppone che tutti i voli vengano dalla stessa popolazione. Fra il 10 settembre e il 9 ottobre le statistiche sono stazionarie — i tre decadi danno 173, 176 e 176 km, indistinguibili fra loro — mentre più avanti cambiano di settimana in settimana: un'ellisse su quei voli descriverebbe una situazione che non si verifica in nessun giorno.",
  wStagH:"La stagione conta",
  wStagP:"La deriva è stabile fino ai primi di ottobre, poi cala rapidamente: il getto subtropicale si ritira verso l'estate australe. La pendenza, stimata anno per anno, ha lo stesso segno in tutti e cinque gli anni.",
  wStPer:"Periodo", wStDrift:"Deriva mediana",
  wSt1:"10–19 settembre", wSt2:"20–29 settembre", wSt3:"30 settembre – 9 ottobre",
  wSt4:"10–19 ottobre", wSt5:"20–29 ottobre", wSt6:"30 ottobre – 8 novembre",
  wStagP2:"Da qui due conseguenze. La data prevista di lancio cade nel periodo <strong>più esigente</strong> di tutta la finestra plausibile: se il lancio slitta, le condizioni migliorano. Ma un rinvio sposta anche la zona di ricaduta verso il sito di partenza, non la restringe soltanto — l'ellisse del periodo di riferimento contiene solo l'85 % degli atterraggi di fine ottobre. Il piano di recupero andrebbe rifatto, non semplicemente ristretto.",
  wOpH:"Le conclusioni operative",
  wOpP:"Lo strumento è stato costruito per rispondere a due domande: da dove lanciare, e se il recupero è fattibile.",
  wOp1:"La deriva è <strong>verso est</strong>, con rotta stabile attorno ai 90° in tutti i periodi e in tutti gli anni.",
  wOp2:"La distanza mediana è di circa <strong>175 km</strong>, e nove voli su dieci restano entro <strong>270 km</strong>: recuperabile su strada.",
  wOp3:"I casi oltre i 400 km esistono, ma sono rari, e il controllo meteo del giorno li esclude.",
  wOpP2:"Da cui la scelta del luogo: partire da un punto abbastanza a ovest perché duecento chilometri verso est restino dentro il paese e lontani dall'Atlantico.",
  wYears:"2021-2025",
  ...
  wParP:"La simulazione è stata fatta usando una velocità di salita di <strong>5 m/s</strong> e una massa di <strong>1,5 kg</strong>. Con questi valori la quantità di elio richiesta è <strong>4,5 m³</strong>, la velocità finale di caduta <strong>4,7 m/s</strong> e la quota di scoppio, ricalcolata giorno per giorno sull'atmosfera reale, dà in media <strong>37,8 km</strong> nel periodo di riferimento, con estremi fra 37,5 e 38,0. Il parametro della massa sarà definitivo in fase di assemblaggio, e la velocità di salita sarà stabilita anche a seconda delle condizioni meteorologiche: le stime delle variabili dipendenti, fra cui la quota di scoppio, sono quindi soggette a variazioni.",
  ...
  wA3P:"I dati mostrano che le ipotesi su cui si basa il modello gaussiano sono ragionevolmente soddisfatte. Tuttavia, va detto che i dati prodotti dal modello non sono tutti veramente indipendenti perché lo stesso sistema meteorologico governa più giorni consecutivi: l'autocorrelazione della deriva è <strong>0,78 a un giorno di distanza e 0,22 a tre</strong>, quindi i centocinquanta voli del periodo di riferimento valgono circa <strong>trentacinque campioni indipendenti</strong>. La mediana è solida; l'ellisse al 90 % va presa come indicativa.",
  wA4H:"La quota di scoppio non è un dato certo",
  wA4P:"Il calcolo ha due soli ingredienti: il diametro a cui il pallone cede, e il profilo di densità dell'aria che attraversa. Il secondo lo ricostruiamo dal profilo atmosferico del giorno — temperatura e quota dei livelli di pressione fino a 24 km — e più in alto da un modello che tiene conto della latitudine e della stagione. L'atmosfera standard che usavamo prima non poteva farlo: essendo un profilo fisso, non sa che fra metà settembre e inizio novembre la stratosfera si scalda di circa 4,5 K e si dilata dell'1,9 %, il che alza la quota di scoppio di <strong>264 metri</strong>. È questo, non la latitudine, il motivo per cui abbiamo cambiato modello.",
  wA4P2:"Tutto quello che sappiamo quantificare — precisione del riempimento, convenzione con cui si misura, massa del carico, estrapolazione sopra i 24 km, variabilità dell'atmosfera — somma in quadratura a <strong>meno di 300 metri</strong>. L'incertezza che domina è un'altra, e non la conosciamo: la dispersione del diametro di rottura del lattice, che entra al cubo nel volume e vale circa <strong>200 metri per ogni punto percentuale</strong>. Su quella dispersione facciamo un'assunzione nostra, non abbiamo un dato del costruttore, ed è la ragione per cui l'incertezza totale è dell'ordine del chilometro e non delle centinaia di metri.",
  wA4P3:"Restano fuori dal conto tre effetti che il dato del costruttore probabilmente contiene già, essendo ricavato dai suoi voli: il riscaldamento dell'elio al Sole, che fa scoppiare più in basso; la dipendenza dell'elasticità del lattice dalla temperatura, che fa scoppiare più in alto; e il degrado del lattice da ozono. I primi due hanno segno opposto e ampiezza confrontabile, e non abbiamo dati per stimarne il saldo. Con una riserva: i lanci del costruttore sono europei, i nostri saranno a 33 gradi di latitudine sud in ottobre, con un'illuminazione e una colonna di ozono diverse.",
  wA4P4:"Il numero, alla fine, lo misurerà il volo stesso. Da pressione e quota all'istante dello scoppio si ricava la densità reale, e da quella il diametro effettivo di quell'esemplare. Un solo campione, ma è esattamente il dato che oggi ci manca.",
  ...
  q14:"Il pallone scoppia quando raggiunge un certo <em>diametro</em>, non una certa quota. Salendo, l'aria si dirada e il pallone si dilata: il calcolo cerca la quota alla quale l'aria è tanto rada da portarlo al diametro di rottura. Quel diametro è un dato empirico del costruttore — 12,5 m per il nostro pallone — non un valore che si ricava dalla teoria. La densità dell'aria viene dai dati meteorologici del giorno fino a 24 km, e più in alto da un modello che tiene conto della latitudine e della stagione. Da qui anche il fatto che sorprende: meno elio significa scoppio più alto, perché il pallone parte più piccolo e ha più strada da fare prima di arrivare al limite. L'incertezza sta quasi tutta nel diametro, che nel volume entra al cubo.",
...
es:{
  ...
  wSimP1:"Simulamos un lanzamiento por día del <strong>10 de setiembre al 8 de noviembre</strong>, durante cinco años: {years}. Sesenta fechas por año, repetidas desde dos puntos de partida — <strong>Durazno</strong> y <strong>Mercedes</strong> — para un total de <strong>600 vuelos simulados</strong>, trescientos por sitio.",
  wSimP2:"Cada punto del mapa es el aterrizaje de uno de esos vuelos, y las casillas de arriba a la derecha encienden y apagan los tres períodos. Las elipses, en cambio, están dibujadas sobre uno solo, el <strong>10 de setiembre – 9 de octubre</strong>, el que contiene la fecha prevista de lanzamiento: partiendo del mismo lugar en ese período, un nuevo lanzamiento tendría cerca del <strong>50 % de probabilidad de caer en la elipse chica</strong> y el <strong>90 % en la grande</strong>.",
  wSimP3:"Sobre los otros dos períodos no hay elipses, y no es un olvido. Una elipse no es un dibujo sino un resumen estadístico, y supone que todos los vuelos vienen de la misma población. Entre el 10 de setiembre y el 9 de octubre las estadísticas son estacionarias — las tres décadas dan 173, 176 y 176 km, indistinguibles entre sí — mientras que más adelante cambian de semana en semana: una elipse sobre esos vuelos describiría una situación que no se da ningún día.",
  wStagH:"La estación importa",
  wStagP:"La deriva es estable hasta los primeros días de octubre, y después cae rápidamente: el chorro subtropical se retira hacia el verano austral. La pendiente, estimada año por año, tiene el mismo signo en los cinco años.",
  wStPer:"Período", wStDrift:"Deriva mediana",
  wSt1:"10–19 de setiembre", wSt2:"20–29 de setiembre", wSt3:"30 de setiembre – 9 de octubre",
  wSt4:"10–19 de octubre", wSt5:"20–29 de octubre", wSt6:"30 de octubre – 8 de noviembre",
  wStagP2:"De aquí, dos consecuencias. La fecha prevista de lanzamiento cae en el período <strong>más exigente</strong> de toda la ventana plausible: si el lanzamiento se corre, las condiciones mejoran. Pero un aplazamiento también mueve la zona de caída hacia el sitio de partida, no solo la achica — la elipse del período de referencia contiene apenas el 85 % de los aterrizajes de fines de octubre. El plan de recuperación habría que rehacerlo, no simplemente reducirlo.",
  wOpH:"Las conclusiones operativas",
  wOpP:"La herramienta se construyó para responder dos preguntas: desde dónde lanzar, y si la recuperación es viable.",
  wOp1:"La deriva es <strong>hacia el este</strong>, con rumbo estable en torno a los 90° en todos los períodos y en todos los años.",
  wOp2:"La distancia mediana es de unos <strong>175 km</strong>, y nueve vuelos de cada diez quedan dentro de <strong>270 km</strong>: recuperable por carretera.",
  wOp3:"Los casos por encima de 400 km existen, pero son raros, y el control meteorológico del día los descarta.",
  wOpP2:"De ahí la elección del lugar: partir de un punto lo bastante al oeste como para que doscientos kilómetros hacia el este queden dentro del país y lejos del Atlántico.",
  wYears:"2021-2025",
  ...
  wA3P:"Los datos muestran que las hipótesis en las que se basa el modelo gaussiano se cumplen razonablemente. Hay que decir, sin embargo, que los datos producidos por el modelo no son todos verdaderamente independientes, porque el mismo sistema meteorológico gobierna varios días seguidos: la autocorrelación de la deriva es de <strong>0,78 a un día de distancia y 0,22 a tres</strong>, así que los ciento cincuenta vuelos del período de referencia valen unas <strong>treinta y cinco muestras independientes</strong>. La mediana es sólida; la elipse al 90 % hay que tomarla como indicativa.",
  wA4H:"La altura de reventado no es un dato cierto",
  wA4P:"El cálculo tiene solo dos ingredientes: el diámetro al que el globo cede, y el perfil de densidad del aire que atraviesa. El segundo lo reconstruimos con el perfil atmosférico del día — temperatura y altura de los niveles de presión hasta 24 km — y más arriba con un modelo que tiene en cuenta la latitud y la estación. La atmósfera estándar que usábamos antes no podía hacerlo: al ser un perfil fijo, no sabe que entre mediados de setiembre y principios de noviembre la estratósfera se calienta unos 4,5 K y se dilata un 1,9 %, lo que sube la altura de reventado <strong>264 metros</strong>. Es esto, y no la latitud, lo que nos hizo cambiar de modelo.",
  wA4P2:"Todo lo que sabemos cuantificar — precisión del llenado, convención con que se mide, masa de la carga, extrapolación por encima de 24 km, variabilidad de la atmósfera — suma en cuadratura <strong>menos de 300 metros</strong>. La incertidumbre que domina es otra, y no la conocemos: la dispersión del diámetro de rotura del látex, que entra al cubo en el volumen y vale unos <strong>200 metros por cada punto porcentual</strong>. Sobre esa dispersión hacemos una suposición nuestra, no tenemos un dato del fabricante, y es la razón por la que la incertidumbre total es del orden del kilómetro y no de los centenares de metros.",
  wA4P3:"Quedan fuera de la cuenta tres efectos que el dato del fabricante probablemente ya contiene, al estar sacado de sus vuelos: el calentamiento del helio al Sol, que hace reventar más abajo; la dependencia de la elasticidad del látex con la temperatura, que hace reventar más arriba; y el degrado del látex por ozono. Los dos primeros tienen signo opuesto y amplitud comparable, y no tenemos datos para estimar el saldo. Con una reserva: los lanzamientos del fabricante son europeos, los nuestros serán a 33 grados de latitud sur en octubre, con una iluminación y una columna de ozono distintas.",
  wA4P4:"El número, al final, lo medirá el propio vuelo. De la presión y la altura en el instante del reventado se obtiene la densidad real, y de ahí el diámetro efectivo de ese ejemplar. Una sola muestra, pero es exactamente el dato que hoy nos falta.",
  ...
  q14:"El globo revienta cuando alcanza un cierto <em>diámetro</em>, no una cierta altura. Al subir, el aire se enrarece y el globo se dilata: el cálculo busca la altura a la que el aire está tan enrarecido como para llevarlo al diámetro de rotura. Ese diámetro es un dato empírico del fabricante — 12,5 m para nuestro globo — no un valor que salga de la teoría. La densidad del aire viene de los datos meteorológicos del día hasta 24 km, y más arriba de un modelo que tiene en cuenta la latitud y la estación. De aquí también el hecho que sorprende: menos helio significa reventado más alto, porque el globo sale más pequeño y tiene más camino que recorrer antes de llegar al límite. La incertidumbre está casi toda en el diámetro, que en el volumen entra al cubo.",
...
en:{
  ...
  wLede:"Before choosing the launch site we simulated <strong>600 flights</strong> from two different places, using the winds actually forecast on the same days of five past years, from 2021 to 2025. The result is that the probe <strong>drifts systematically eastwards</strong>: in the month containing the planned launch date the median distance is <strong>173 km</strong>.",
  ...
  wSimP1:"We simulated one launch a day from <strong>10 September to 8 November</strong>, over five years: {years}. Sixty dates a year, repeated from two starting points — <strong>Durazno</strong> and <strong>Mercedes</strong> — for a total of <strong>600 simulated flights</strong>, three hundred per site.",
  wSimP2:"Every dot on the map is the landing of one of those flights, and the checkboxes at the top right switch the three periods on and off. The ellipses, though, are drawn on one period only — <strong>10 September to 9 October</strong>, the one containing the planned launch date: starting from the same place in that period, a new launch would have about a <strong>50 % chance of landing inside the small ellipse</strong> and <strong>90 % inside the large one</strong>.",
  wSimP3:"The other two periods have no ellipses, and that is not an oversight. An ellipse is not a drawing but a statistical summary, and it assumes all the flights come from one population. Between 10 September and 9 October the statistics are stationary — the three ten-day blocks give 173, 176 and 176 km, indistinguishable from one another — whereas later on they change from week to week: an ellipse over those flights would describe a situation that occurs on no day at all.",
  wStagH:"The season matters",
  wStagP:"Drift is stable until the first days of October, then falls quickly: the subtropical jet retreats towards the southern summer. The slope, estimated year by year, has the same sign in all five years.",
  wStPer:"Period", wStDrift:"Median drift",
  wSt1:"10–19 September", wSt2:"20–29 September", wSt3:"30 September – 9 October",
  wSt4:"10–19 October", wSt5:"20–29 October", wSt6:"30 October – 8 November",
  wStagP2:"Two consequences follow. The planned launch date falls in the <strong>most demanding</strong> period of the whole plausible window: if the launch slips, conditions improve. But a postponement also moves the landing area back towards the launch site, it does not merely shrink it — the reference-period ellipse contains only 85 % of the late-October landings. The recovery plan would have to be redone, not simply narrowed.",
  wOpH:"The operational conclusions",
  wOpP:"The tool was built to answer two questions: where to launch from, and whether recovery is feasible.",
  wOp1:"The drift is <strong>eastward</strong>, on a steady bearing of about 90° in every period and every year.",
  wOp2:"The median distance is about <strong>175 km</strong>, and nine flights out of ten stay within <strong>270 km</strong>: recoverable by road.",
  wOp3:"Cases beyond 400 km exist, but they are rare, and the weather check on the day rules them out.",
  wOpP2:"Hence the choice of site: start far enough west that two hundred kilometres eastward stay inside the country and well away from the Atlantic.",
  wYears:"2021-2025",
  ...
  wParP:"The simulation was run using an ascent rate of <strong>5 m/s</strong> and a mass of <strong>1.5 kg</strong>. With these values the helium required is <strong>4.5 m³</strong>, the final descent speed <strong>4.7 m/s</strong>, and the burst altitude — recomputed day by day against the real atmosphere — averages <strong>37.8 km</strong> over the reference period, ranging between 37.5 and 38.0. The mass will be final at the assembly stage, and the ascent rate will also be set according to the weather: the estimates of the dependent variables, burst altitude among them, are therefore subject to change.",
  ...
  wA3P:"The data show that the assumptions behind the Gaussian model hold reasonably well. It should be said, however, that the data produced by the model are not all truly independent, because the same weather system governs several consecutive days: the autocorrelation of drift is <strong>0.78 at one day and 0.22 at three</strong>, so the hundred and fifty flights of the reference period are worth about <strong>thirty-five independent samples</strong>. The median is solid; the 90 % ellipse should be taken as indicative.",
  wA4H:"The burst altitude is not a certain figure",
  wA4P:"The calculation has just two ingredients: the diameter at which the balloon gives way, and the density profile of the air it climbs through. The second we rebuild from the atmospheric profile of the day — temperature and height of the pressure levels up to 24 km — and higher up from a model that accounts for latitude and season. The standard atmosphere we used before could not do this: being a fixed profile, it does not know that between mid-September and early November the stratosphere warms by about 4.5 K and expands by 1.9 %, which raises the burst altitude by <strong>264 metres</strong>. That, and not latitude, is why we changed model.",
  wA4P2:"Everything we can quantify — filling accuracy, the convention it is measured by, payload mass, extrapolation above 24 km, atmospheric variability — adds in quadrature to <strong>less than 300 metres</strong>. The dominant uncertainty is something else, and we do not know it: the spread of the latex burst diameter, which enters the volume cubed and is worth about <strong>200 metres per percentage point</strong>. On that spread we make an assumption of our own — we have no figure from the manufacturer — and it is why the total uncertainty is of the order of a kilometre rather than hundreds of metres.",
  wA4P3:"Three effects stay outside the budget, and the manufacturer's figure probably already contains them, being drawn from their own flights: the helium warming in the Sun, which bursts the balloon lower; the temperature dependence of latex elasticity, which bursts it higher; and ozone degradation of the latex. The first two have opposite signs and comparable size, and we have no data to estimate the balance. With one reservation: their launches are European, ours will be at 33 degrees south in October, under different sunlight and a different ozone column.",
  wA4P4:"In the end the flight itself will measure the number. From pressure and altitude at the moment of the burst you get the real density, and from that the actual diameter of that particular balloon. A single sample, but it is exactly the figure we lack today.",
  ...
  q14:"The balloon bursts when it reaches a certain <em>diameter</em>, not a certain altitude. As it climbs the air thins and the balloon expands: the calculation looks for the altitude at which the air is thin enough to bring it to its bursting diameter. That diameter is an empirical figure from the manufacturer — 12.5 m for our balloon — not something derived from theory. Air density comes from the weather data of the day up to 24 km, and higher up from a model that accounts for latitude and season. Hence the fact that surprises people: less helium means a higher burst, because the balloon starts smaller and has further to go before reaching the limit. Almost all the uncertainty sits in the diameter, which enters the volume cubed.",
