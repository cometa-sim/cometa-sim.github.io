...
en:{
  ...
  q13b:"That still leaves rivers, lakes and reservoirs. According to MapBiomas, inland water covers about <strong>3 % of Uruguay</strong>, so a probe falling on a random point of the country would end up in water three times out of a hundred. But ours does not fall on a random point: it falls near a predicted one, which we will choose far from water. That 3 % is an upper bound — the real probability is lower.",
