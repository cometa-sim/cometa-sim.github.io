...
it:{
  ...
  twP2:"Tawhiri calcola solo dove porta il vento: quota di scoppio e velocità di discesa gliele diamo noi, con lo stesso modello del pallone usato nello studio più sotto. La previsione copre circa <strong>una settimana</strong> ed è tanto più affidabile quanto più il giorno è vicino. È una traiettoria sola, senza un'incertezza associata: per capire quanto fidarsi conviene ripetere il calcolo nei giorni successivi e guardare di quanto si sposta il punto di atterraggio.",
  ...
  twCylLeft:"bar da consumare · bombola a 15 °C",
  twCyl:"Bombola",
...
es:{
  ...
  twP2:"Tawhiri calcula solo adónde lleva el viento: la altura de reventado y la velocidad de descenso se las damos nosotros, con el mismo modelo del globo usado en el estudio más abajo. El pronóstico cubre alrededor de <strong>una semana</strong>, y es más confiable cuanto más cerca está el día. Es una sola trayectoria, sin una incertidumbre asociada: para saber cuánto fiarse conviene repetir el cálculo en los días siguientes y ver cuánto se mueve el punto de aterrizaje.",
  ...
  twCylLeft:"bar a consumir · cilindro a 15 °C",
  twCyl:"Cilindro",
...
en:{
  ...
  twP2:"Tawhiri only works out where the wind carries the balloon: the burst altitude and the descent rate come from us, from the same balloon model used in the study below. The forecast covers about <strong>a week</strong>, and the closer the day, the more reliable it is. It is a single trajectory, with no uncertainty attached: to judge how far to trust it, repeat the calculation on the following days and see how much the landing point moves.",
  ...
  twCylLeft:"bar to use · cylinder at 15 °C",
  twCyl:"Cylinder",
