...
es:{
  ...
  twIsa:"La altura de reventado se calcula con la atmósfera pronosticada para el lugar, el día y la hora de partida; si esos datos no llegan, con la atmósfera estándar (ISA). El cilindro se considera a 15 °C, teniendo en cuenta que a 200 bar el helio no se comporta como un gas ideal. Si no se fija a mano, el paracaídas es el del kit: 1,2 m de diámetro, coeficiente de resistencia 1,0, masa 80 g.",
  twWCyl:"El cilindro no alcanza: hacen falta {v} m³ de helio y contiene unos {c}.",
  twCylLeft:"bar consumidos · quedan {p}",
  twCyl:"Cilindro · 200 bar",
