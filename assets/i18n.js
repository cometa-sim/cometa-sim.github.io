...
it:{
  ...
  ph2p:"Salendo, l'aria si dirada e la temperatura scende di circa 6,5 °C ogni chilometro: a undici chilometri siamo a −56 °C. La ragione non è la distanza dal Sole, che salendo semmai diminuisce. È che il Sole non scalda l'aria direttamente: la attraversa quasi indisturbato e scalda il suolo, che a sua volta riscalda l'aria dal basso — quindi più ci si allontana da terra, meno arriva quel calore. A questo si aggiunge l'effetto della gravità, che comprime l'atmosfera verso il basso: salendo la pressione cala, l'aria si espande e occupa più spazio, e per espandersi consuma energia. Un gas che si espande si raffredda.",
...
es:{
  ...
  ph2p:"Al subir, el aire se enrarece y la temperatura baja unos 6,5 °C por kilómetro: a once kilómetros estamos a −56 °C. La razón no es la distancia al Sol, que al subir incluso disminuye. Es que el Sol no calienta el aire directamente: lo atraviesa casi sin tocarlo y calienta el suelo, que a su vez calienta el aire desde abajo — así que cuanto más nos alejamos de la tierra, menos llega ese calor. A esto se suma el efecto de la gravedad, que comprime la atmósfera hacia abajo: al subir la presión cae, el aire se expande y ocupa más espacio, y para expandirse consume energía. Un gas que se expande se enfría.",
...
en:{
  ...
  ph2p:"As it climbs, the air thins and the temperature drops by about 6.5 °C per kilometre: at eleven kilometres we are at −56 °C. The reason is not distance from the Sun, which if anything decreases as you rise. It is that the Sun does not heat the air directly: it passes through almost untouched and heats the ground, which in turn warms the air from below — so the further you get from the ground, the less of that heat arrives. Added to this is gravity, which compresses the atmosphere downwards: as you climb the pressure falls, the air expands and takes up more space, and expanding costs energy. A gas that expands cools.",
