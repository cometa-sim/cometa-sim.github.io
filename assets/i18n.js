...
it:{
  ...
  wLede:"Prima di scegliere il luogo di lancio abbiamo simulato <strong>600 voli</strong> da due località diverse, usando i venti realmente previsti negli stessi giorni di cinque anni passati, dal 2021 al 2025. Il risultato è che la sonda <strong>deriva sistematicamente verso est</strong>: nel mese che contiene la data prevista di lancio metà dei voli atterra entro <strong>173 km</strong>, e nove su dieci entro 272.",
  wTraj:"Traiettorie simulate", wDrift:"Deriva tipica", wBearing:"Rotta media", wDur:"Durata media", wBearingU:"(est)",
  ...
  wSimP1:"Abbiamo simulato un lancio al giorno dal 10 settembre all'8 novembre, per <strong>cinque anni: {years}</strong>. Sessanta date per anno, ripetute da due punti di partenza — Durazno e Mercedes — per un totale di <strong>600 voli simulati</strong>, trecento per sito.",
  wSimP2:"Ogni punto sulla mappa è l'atterraggio di uno di questi voli, e le spunte in alto a destra accendono e spengono i tre periodi. Fra il <strong>10 settembre e il 9 ottobre</strong> le statistiche sono stazionarie, e per quel periodo possiamo disegnare delle ellissi con un significato preciso: partendo dallo stesso luogo in quei giorni, un nuovo lancio avrebbe circa il <strong>50 % di probabilità di cadere nell'ellisse piccola</strong> e il <strong>90 % nella grande</strong>. Più avanti nella stagione la deriva diminuisce progressivamente, e su quei voli un'ellisse non avrebbe lo stesso significato.",
  ...
  wGCap:"Deriva tipica per periodi di dieci giorni, dal 10 settembre all'8 novembre.",
  wGAlt:"La deriva tipica scende da 173 km a metà settembre a 76 km a fine ottobre.",
  wStagP2:"La data prevista di lancio cade nel periodo <strong>più esigente</strong> di tutta la finestra plausibile: se il lancio slitta, le condizioni migliorano.",
  wYears:"2021-2025",
...
es:{
  ...
  wLede:"Antes de elegir el lugar de lanzamiento simulamos <strong>600 vuelos</strong> desde dos localidades distintas, usando los vientos realmente previstos en los mismos días de cinco años pasados, de 2021 a 2025. El resultado es que la sonda <strong>deriva sistemáticamente hacia el este</strong>: en el mes que contiene la fecha prevista de lanzamiento la mitad de los vuelos aterriza dentro de <strong>173 km</strong>, y nueve de cada diez dentro de 272.",
  wTraj:"Trayectorias simuladas", wDrift:"Deriva típica", wBearing:"Rumbo medio", wDur:"Duración media", wBearingU:"(este)",
  wStatNote:"Deriva, rumbo y duración se refieren al período 10 de setiembre – 9 de octubre, el de la fecha prevista de lanzamiento; las trayectorias simuladas son las 600.",
  wSimHead:"La simulación",
  wSimP1:"Simulamos un lanzamiento por día del 10 de setiembre al 8 de noviembre, durante <strong>cinco años: {years}</strong>. Sesenta fechas por año, repetidas desde dos puntos de partida — Durazno y Mercedes — para un total de <strong>600 vuelos simulados</strong>, trescientos por sitio.",
  wSimP2:"Cada punto del mapa es el aterrizaje de uno de esos vuelos, y las casillas de arriba a la derecha encienden y apagan los tres períodos. Entre el <strong>10 de setiembre y el 9 de octubre</strong> las estadísticas son estacionarias, y para ese período podemos dibujar elipses con un significado preciso: partiendo del mismo lugar en esos días, un nuevo lanzamiento tendría cerca del <strong>50 % de probabilidad de caer en la elipse chica</strong> y el <strong>90 % en la grande</strong>. Más adelante en la estación la deriva disminuye progresivamente, y sobre esos vuelos una elipse no tendría el mismo significado.",
  ...
  wGCap:"Deriva típica por períodos de diez días, del 10 de setiembre al 8 de noviembre.",
  wGAlt:"La deriva típica baja de 173 km a mediados de setiembre a 76 km a fines de octubre.",
  wStagP2:"La fecha prevista de lanzamiento cae en el período <strong>más exigente</strong> de toda la ventana plausible: si el lanzamiento se corre, las condiciones mejoran.",
  wYears:"2021-2025",
  ...
  wParP:"La atmósfera no es un perfil fijo: usamos la del día. Temperatura y altura de los niveles de presión vienen de los datos meteorológicos hasta 24 km, y más arriba de un modelo que tiene en cuenta la latitud y la estación — entre setiembre y noviembre la estratósfera se calienta y se dilata, y eso solo ya sube la altura de reventado unos cientos de metros.",
  wParP2:"La simulación se hizo con una velocidad de ascenso de <strong>5 m/s</strong> y una masa de <strong>1,5 kg</strong>. Con estos valores el helio necesario es <strong>4,5 m³</strong>, la velocidad final de caída <strong>4,7 m/s</strong> y la altura de reventado, recalculada día por día, queda entre 37,5 y 38,0 km. La masa será definitiva en la etapa de armado y la velocidad de ascenso se decidirá también según el tiempo: todo lo que se deriva de ello está por lo tanto sujeto a variaciones.",
  ...
  wUseP2:"Para eso usaremos una herramienta de pronóstico mucho más precisa, que sin embargo funciona solo pocos días antes del lanzamiento. Lo que este análisis nos dice es que la deriva es hacia el este, con rumbo estable en torno a los 90° en todos los períodos y en todos los años; que la mitad de los vuelos queda dentro de 175 km y nueve de cada diez dentro de 270, o sea recuperables por carretera; y que los casos por encima de 400 km existen pero son raros, y el control meteorológico del día los descarta. De ahí la elección del lugar: partir lo bastante al oeste como para que doscientos kilómetros hacia el este queden dentro del país y lejos del Atlántico. El lugar de lanzamiento está condicionado también por las <a data-page=\"legale\" tabindex=\"0\">disposiciones de las autoridades aeronáuticas</a>.",
...
en:{
  ...
  wLede:"Before choosing the launch site we simulated <strong>600 flights</strong> from two different places, using the winds actually forecast on the same days of five past years, from 2021 to 2025. The result is that the probe <strong>drifts systematically eastwards</strong>: in the month containing the planned launch date half the flights land within <strong>173 km</strong>, and nine out of ten within 272.",
  wTraj:"Simulated trajectories", wDrift:"Typical drift", wBearing:"Mean bearing", wDur:"Mean duration", wBearingU:"(east)",
  ...
  wSimP1:"We simulated one launch a day from 10 September to 8 November, over <strong>five years: {years}</strong>. Sixty dates a year, repeated from two starting points — Durazno and Mercedes — for a total of <strong>600 simulated flights</strong>, three hundred per site.",
  wSimP2:"Every dot on the map is the landing of one of those flights, and the checkboxes at the top right switch the three periods on and off. Between <strong>10 September and 9 October</strong> the statistics are stationary, and for that period we can draw ellipses with a precise meaning: starting from the same place on those days, a new launch would have about a <strong>50 % chance of landing inside the small ellipse</strong> and <strong>90 % inside the large one</strong>. Later in the season the drift falls off steadily, and over those flights an ellipse would not carry the same meaning.",
  ...
  wGCap:"Typical drift over ten-day periods, from 10 September to 8 November.",
  wGAlt:"Typical drift falls from 173 km in mid-September to 76 km at the end of October.",
  wStagP2:"The planned launch date falls in the <strong>most demanding</strong> period of the whole plausible window: if the launch slips, conditions improve.",
  wYears:"2021-2025",
  ...
  wUseP2:"For that we will use a far more precise forecasting tool, which however only works a few days before the launch. What this analysis does tell us is that the drift is eastward, on a steady bearing of about 90° in every period and every year; that half the flights stay within 175 km and nine out of ten within 270, so recoverable by road; and that cases beyond 400 km exist but are rare, and the weather check on the day rules them out. Hence the choice of site: start far enough west that two hundred kilometres eastward stay inside the country and well away from the Atlantic. The launch site is also constrained by the <a data-page=\"legale\" tabindex=\"0\">rules of the aviation authorities</a>.",
