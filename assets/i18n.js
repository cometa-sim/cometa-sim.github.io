...
it:{
  ...
  /* — Studio dei venti — */
  wKicker:"Fase 1 · Traiettoria", windsTitle:"Dove va a finire la sonda",
  windsSub:"Uno strumento per prevedere il volo nei giorni del lancio, e lo studio con cui abbiamo scelto da dove partire.",
  ...
  wStagQ:"Come anticipato, fra settembre e novembre il modello fa scaldare e dilatare la stratosfera, e la quota di scoppio cresce di conseguenza. Non è un risultato della simulazione: è il fenomeno di cui la simulazione tiene conto, giorno per giorno, nel periodo che ci interessa.",
  ...
  mapHint:"Cliccando un punto compare la data di quel volo.",
  ...
  /* — Previsione del giorno (Tawhiri) — */
  twHead:"Prevedere il volo",
  twP1:"Lo script determina la dinamica in verticale del pallone — salita, scoppio e discesa — e la traiettoria.",
  twP1c:"La traiettoria la calcola <strong>Tawhiri</strong>, il predittore per palloni sonda gestito da SondeHub, sui venti dell'ultima previsione del modello globale <strong>GFS</strong> della NOAA, rifatta ogni sei ore.",
  twP1b:"Per la fisica del pallone usiamo un modello atmosferico che è diverso ogni giorno. Temperatura e quota dei livelli di pressione vengono dai dati meteorologici fino a <strong>24 km</strong>, e più in alto da un modello che tiene conto della latitudine e della stagione — fra settembre e novembre la stratosfera si scalda e si dilata, influendo sulla quota di scoppio.",
  twP2:"Tawhiri calcola solo dove porta il vento: quota di scoppio e velocità di discesa gliele diamo noi, con lo stesso modello del pallone usato nello studio più sotto. La previsione copre circa <strong>una settimana</strong> ed è tanto più affidabile quanto più il giorno è vicino.",
  twDate:"Giorno", twTime:"Ora di lancio (Uruguay)", twAsc:"Salita · m/s", twBurst:"Scoppio · km", twDesc:"Discesa al suolo · m/s",
  twRun:"Calcola la traiettoria", twWeek:"Confronta i prossimi giorni",
  twLoading:"Calcolo in corso…", twDone:"Previsione GFS del {run}, ore dell'Uruguay.",
  twErr:"Tawhiri non ha risposto: {msg}", twNoNet:"il servizio non è raggiungibile, riprova tra qualche minuto.",
  twBad:"Controlla i valori: salita fra 1 e 10 m/s, scoppio fra 10 e 45 km, discesa fra 1 e 15 m/s.",
  twLand:"Atterraggio", twDrift:"Deriva", twBear:"Rotta", twDur:"Durata del volo", twAt:"Tocca terra alle", twBurstDist:"Scoppio a",
  twMaps:"Apri il punto in Google Maps",
  twOk:"Fuori dall'area di esclusione", twEscl:"Dentro l'area di esclusione", twFuori:"Fuori dall'Uruguay",
  twLegend:"Stella: partenza · linea piena: salita · tratteggio: discesa · cerchio bianco: scoppio.",
  twWDay:"Giorno", twWeekNote:"Stesso luogo, stessa ora e stesso pallone per tutti i giorni. Cliccando una riga, quella previsione compare sulla mappa.",
  twNote:"L'area di esclusione è il poligono approssimato usato anche nello studio.",
  srcTw:"<strong>Previsione del giorno:</strong> predittore Tawhiri di <a href=\"https://sondehub.org/\" target=\"_blank\" rel=\"noopener\">SondeHub</a>, sui venti del modello GFS della <a href=\"https://www.noaa.gov/\" target=\"_blank\" rel=\"noopener\">NOAA</a>; atmosfera del giorno dalla Forecast API di Open-Meteo e, sopra i 24 km, da NRLMSIS 2.1.",
  vStudyHead:"Lo studio dei venti",
  vIdxCalc:"Come si calcola",
  twGStart:"Partenza",
  twWhere:"Luogo di lancio",
  twWherePh:"Località o coordinate",
  twWhereHint:"Scrivi il nome di una località o le coordinate (per esempio -33.38, -56.52), oppure tocca la mappa.",
  twGeo:"Usa la mia posizione",
  twGeoErr:"Posizione non disponibile.",
  twGeoWait:"Cerco la posizione…",
  twGeoDenied:"Il browser non ha il permesso di usare la posizione: si attiva dalle impostazioni del sito.",
  twNoPlace:"Scegli prima il luogo di lancio.",
  twStudied:"sito dello studio",
  twNoRes:"Nessuna località trovata.",
  twPoint:"Punto sulla mappa",
  twGBalloon:"Pallone",
  twBalloon:"Modello",
  twDiam:"Ø di scoppio · m",
  twMass:"Massa pallone · kg",
  twPayload:"Payload · kg",
  twChute:"Paracadute Ø · m",
  twHe:"Elio necessario",
  twNeck:"Portanza al collo",
  twBurstC:"Quota di scoppio",
  twDescC:"Discesa al suolo",
  twIsa:"La quota di scoppio è calcolata con l'atmosfera prevista per il luogo, il giorno e l'ora della partenza; se quei dati non arrivano, con l'atmosfera standard (ISA). La bombola è considerata a 200 bar, se non si imposta a mano la pressione letta sul manometro, e a 15 °C, tenendo conto che a quelle pressioni l'elio non si comporta come un gas ideale. Se non lo si imposta a mano, il paracadute è quello del kit: 1,2 m di diametro, coefficiente di resistenza 1,0, massa 80 g.",
  twTBurst:"Tempo allo scoppio",
  twPCyl:"Pressione bombola · bar",
  twWCyl:"La bombola non basta: servono {v} m³ di elio e ne contiene circa {c}.",
  twCylLeft:"bombola a 15 °C",
  twCyl:"Bombola",
  twCardHand:"Quota di scoppio impostata a mano.",
  twCardStd:"Quota di scoppio calcolata con l'atmosfera standard: i dati del giorno non erano disponibili.",
  twCardDay:"Quota di scoppio calcolata con l'atmosfera prevista per quel giorno e quell'ora.",
  twAtmoStd:"atmosfera standard",
  twAtmoDay:"atmosfera del giorno",
  twManual:"Impostazioni avanzate",
  twManHint:"Se restano vuoti valgono i dati del modello scelto e i valori calcolati.",
  twLegendBand:"Stella: partenza · fascia: le traiettorie di tutte le partenze · arancione: la zona di atterraggio.",
  twMapsMid:"Apri il punto medio in Google Maps",
  twSpreadV:"entro {d} km dal punto medio",
  twSpread:"Atterraggi",
  twLandMid:"Atterraggio medio",
  twOfN:"{k} su {n}",
  twNFlights:"Partenze calcolate",
  twProgress:"Calcolo in corso… {i} di {n}",
  twTooMany:"Troppe partenze ({n}): al massimo {m}. Accorcia l'intervallo o allunga il passo.",
  twBadRange:"Controlla le partenze: il giorno e l'ora finali devono venire dopo quelli iniziali.",
  twMultiHint:"Dal giorno e dall'ora scelti sopra fino a questi. Se restano vuoti si calcola una sola partenza.",
  twErrH:"Errore sull'atterraggio",
  twErrOn:"Calcola l'errore",
  twErrSig:"Diametro di scoppio · ± %",
  twErrHint:"La quota di scoppio è la fonte di errore principale: dipende dal diametro a cui il lattice cede, che varia da un pallone all'altro. Si ricalcola la traiettoria con lo scoppio più basso e più alto. Solo per una partenza singola.",
  twErrLand:"Errore sull'atterraggio",
  twBurstRange:"Scoppio fra",
  twLegendErr:"Segmento arancione: dove cade con lo scoppio più basso e più alto.",
  twEvery:"Ogni",
  twToTime:"Fino alle ore",
  twToDay:"Fino al giorno",
  twMulti:"Più partenze",
  twHand:"a mano",
  twStart:"Partenza",
  twGround:"{m} m s.l.m. (quota del terreno)",
  twWHeavy:"Il payload è troppo pesante: con questo pallone non si sale a questa velocità.",
  twWPay:"Il payload supera il massimo nominale del pallone ({max} g).",
  twWBurst:"Parametri incompatibili: il pallone scoppierebbe sotto i 30 km. È troppo piccolo per questo carico e questa salita.",
  twWSlow:"Salita sotto i 3 m/s: volo lungo, deriva ampia, rischio che il pallone galleggi senza scoppiare.",
  twWDesc:"Discesa al suolo troppo veloce ({v} m/s): oltre i 6 m/s l'urto rischia di danneggiare la sonda. Per 5 m/s serve un paracadute di almeno {d} m.",
  twWBad:"Parametri incompleti o incompatibili: controlla i valori del pallone.",
  ...
  lClassOut:"La sonda Klo-01 è un pallone <strong>«leggero»</strong>: pesa poco più di un terzo della soglia dei 4 kg, il collo è unico e ben sotto i 3 kg, la sua densità è quasi quattro volte inferiore al limite, e il cordame cede prima dei 230 N. Quest'ultimo criterio è necessario affinché, in caso di urto con un velivolo, il pallone si separi dalla sonda.",
  ...
  msNot1:"<strong>L'ozono e gli ossidi di azoto.</strong> I sensori disponibili a questo costo sono tarati per l'aria a livello del mare; alle pressioni della stratosfera la loro risposta non è interpretabile, e non esiste un modo praticabile di calibrarli per quelle condizioni. Inserendo questi sensori avremmo ottenuto numeri impossibili da interpretare.",
  ...
  orgDiscord:"I gruppi si coordinano su un server Discord: un canale per le comunicazioni ufficiali, uno per ciascun gruppo, uno dove si registrano gli avanzamenti e uno per i dubbi tecnici, aperto a tutti, mentre i referenti ne hanno uno loro. La regola è: se non è nel server Discord, non esiste.",
  ...
  pg6t:"Ordine del materiale", pg6:"Non è stato un ordine solo. Il materiale di volo — pallone, paracadute, scatola, videocamera e i due tracciatori — arriva da StratoFlights ed è già qui. Anche l'elio, che si compra in Uruguay, è arrivato: una bombola da 40 litri a circa 200 bar, cioè 8,3 m³ di gas. È elio di purezza 5.0, cioè 99,999 %. I sensori e l'elettronica sono ordinati e li stiamo aspettando.",
  ...
  q3:"Il record per un pallone non pilotato è di circa 53 km, ottenuto in Giappone nel 2013 con una pellicola sottilissima e un carico minimo. Ma quel record è di un tipo di pallone diverso dal nostro. I nostri sono <em>elastici</em>: si gonfiano finché il lattice cede, e il volo finisce lì. Quelli da record sono <em>a volume costante</em>, gonfi solo in parte alla partenza, e si fermano quando l'aria attorno diventa rada quanto il gas che hanno dentro. Ed è questo il limite vero, per tutti: si sale finché c'è aria più densa del gas del pallone. Quando non ce n'è più, non c'è più spinta, indipendentemente dalla quantità di elio.",
  ...
  wMod3:"<strong>Quanto resta in aria e perché conta qui.</strong> La deriva è, in sostanza, velocità del vento moltiplicata per il tempo passato dentro di esso. Rallentare la salita per guadagnare quota allunga il volo, e quindi allunga la deriva: passare da 5 a 4 m/s aggiungerebbe circa ottocento metri di quota e trentacinque minuti di volo, con un aumento della deriva dell'ordine del 15-20 %. Lo studio qui sotto è il punto di partenza: la scelta definitiva si affina con la previsione dei giorni prima del lancio.",
...
es:{
  ...
  wKicker:"Fase 1 · Trayectoria", windsTitle:"Dónde va a caer la sonda",
  windsSub:"Una herramienta para pronosticar el vuelo en los días del lanzamiento, y el estudio con el que elegimos desde dónde partir.",
  ...
  wStagQ:"Como se anticipó, entre septiembre y noviembre el modelo hace que la estratósfera se caliente y se dilate, y la altura de reventado crece en consecuencia. No es un resultado de la simulación: es el fenómeno que la simulación tiene en cuenta, día por día, en el período que nos interesa.",
  ...
  mapHint:"Al hacer clic en un punto aparece la fecha de ese vuelo.",
  ...
  /* — Pronóstico del día (Tawhiri) — */
  twHead:"Pronosticar el vuelo",
  twP1:"El script determina la dinámica vertical del globo — ascenso, reventado y descenso — y la trayectoria.",
  twP1c:"La trayectoria la calcula <strong>Tawhiri</strong>, el predictor para globos sonda que mantiene SondeHub, sobre los vientos del último pronóstico del modelo global <strong>GFS</strong> de la NOAA, que se rehace cada seis horas.",
  twP1b:"Para la física del globo usamos un modelo atmosférico que es distinto cada día. La temperatura y la altura de los niveles de presión vienen de los datos meteorológicos hasta <strong>24 km</strong>, y más arriba de un modelo que tiene en cuenta la latitud y la estación — entre septiembre y noviembre la estratósfera se calienta y se dilata, lo que influye en la altura de reventado.",
  twP2:"Tawhiri calcula solo adónde lleva el viento: la altura de reventado y la velocidad de descenso se las damos nosotros, con el mismo modelo del globo usado en el estudio más abajo. El pronóstico cubre alrededor de <strong>una semana</strong>, y es más confiable cuanto más cerca está el día.",
  twDate:"Día", twTime:"Hora de lanzamiento (Uruguay)", twAsc:"Ascenso · m/s", twBurst:"Reventado · km", twDesc:"Descenso al suelo · m/s",
  twRun:"Calcular la trayectoria", twWeek:"Comparar los próximos días",
  twLoading:"Calculando…", twDone:"Pronóstico GFS del {run}, hora de Uruguay.",
  twErr:"Tawhiri no respondió: {msg}", twNoNet:"el servicio no está disponible, probá de nuevo en unos minutos.",
  twBad:"Revisá los valores: ascenso entre 1 y 10 m/s, reventado entre 10 y 45 km, descenso entre 1 y 15 m/s.",
  twLand:"Aterrizaje", twDrift:"Deriva", twBear:"Rumbo", twDur:"Duración del vuelo", twAt:"Toca tierra a las", twBurstDist:"Reventado a",
  twMaps:"Abrir el punto en Google Maps",
  twOk:"Fuera del área de exclusión", twEscl:"Dentro del área de exclusión", twFuori:"Fuera de Uruguay",
  twLegend:"Estrella: partida · línea continua: ascenso · punteada: descenso · círculo blanco: reventado.",
  twWDay:"Día", twWeekNote:"Mismo lugar, misma hora y mismo globo para todos los días. Al hacer clic en una fila, ese pronóstico aparece en el mapa.",
  twNote:"El área de exclusión es el polígono aproximado que se usó también en el estudio.",
  srcTw:"<strong>Pronóstico del día:</strong> predictor Tawhiri de <a href=\"https://sondehub.org/\" target=\"_blank\" rel=\"noopener\">SondeHub</a>, sobre los vientos del modelo GFS de la <a href=\"https://www.noaa.gov/\" target=\"_blank\" rel=\"noopener\">NOAA</a>; atmósfera del día de la Forecast API de Open-Meteo y, por encima de 24 km, de NRLMSIS 2.1.",
  vStudyHead:"El estudio de los vientos",
  vIdxCalc:"Cómo se calcula",
  twGStart:"Partida",
  twWhere:"Lugar de lanzamiento",
  twWherePh:"Localidad o coordenadas",
  twWhereHint:"Escribí el nombre de una localidad o las coordenadas (por ejemplo -33.38, -56.52), o tocá el mapa.",
  twGeo:"Usar mi ubicación",
  twGeoErr:"Ubicación no disponible.",
  twGeoWait:"Buscando la ubicación…",
  twGeoDenied:"El navegador no tiene permiso para usar la ubicación: se activa en la configuración del sitio.",
  twNoPlace:"Primero elegí el lugar de lanzamiento.",
  twStudied:"sitio del estudio",
  twNoRes:"No se encontró ninguna localidad.",
  twPoint:"Punto en el mapa",
  twGBalloon:"Globo",
  twBalloon:"Modelo",
  twDiam:"Ø de reventado · m",
  twMass:"Masa del globo · kg",
  twPayload:"Carga útil · kg",
  twChute:"Paracaídas Ø · m",
  twHe:"Helio necesario",
  twNeck:"Sustentación en el cuello",
  twBurstC:"Altura de reventado",
  twDescC:"Descenso al suelo",
  twIsa:"La altura de reventado se calcula con la atmósfera pronosticada para el lugar, el día y la hora de partida; si esos datos no llegan, con la atmósfera estándar (ISA). El cilindro se considera a 200 bar, si no se fija a mano la presión leída en el manómetro, y a 15 °C, teniendo en cuenta que a esas presiones el helio no se comporta como un gas ideal. Si no se fija a mano, el paracaídas es el del kit: 1,2 m de diámetro, coeficiente de resistencia 1,0, masa 80 g.",
  twTBurst:"Tiempo al reventado",
  twPCyl:"Presión del cilindro · bar",
  twWCyl:"El cilindro no alcanza: hacen falta {v} m³ de helio y contiene unos {c}.",
  twCylLeft:"cilindro a 15 °C",
  twCyl:"Cilindro",
  twCardHand:"Altura de reventado fijada a mano.",
  twCardStd:"Altura de reventado calculada con la atmósfera estándar: los datos del día no estaban disponibles.",
  twCardDay:"Altura de reventado calculada con la atmósfera pronosticada para ese día y esa hora.",
  twAtmoStd:"atmósfera estándar",
  twAtmoDay:"atmósfera del día",
  twManual:"Configuración avanzada",
  twManHint:"Si quedan vacíos, valen los datos del modelo elegido y los valores calculados.",
  twLegendBand:"Estrella: partida · franja: las trayectorias de todas las partidas · naranja: la zona de aterrizaje.",
  twMapsMid:"Abrir el punto medio en Google Maps",
  twSpreadV:"dentro de {d} km del punto medio",
  twSpread:"Aterrizajes",
  twLandMid:"Aterrizaje medio",
  twOfN:"{k} de {n}",
  twNFlights:"Partidas calculadas",
  twProgress:"Calculando… {i} de {n}",
  twTooMany:"Demasiadas partidas ({n}): como máximo {m}. Acortá el intervalo o alargá el paso.",
  twBadRange:"Revisá las partidas: el día y la hora finales tienen que ser posteriores a los iniciales.",
  twMultiHint:"Desde el día y la hora elegidos arriba hasta estos. Si quedan vacíos, se calcula una sola partida.",
  twErrH:"Error en el aterrizaje",
  twErrOn:"Calcular el error",
  twErrSig:"Diámetro de reventado · ± %",
  twErrHint:"La altura de reventado es la principal fuente de error: depende del diámetro al que cede el látex, que varía de un globo a otro. Se recalcula la trayectoria con el reventado más bajo y más alto. Solo para una partida única.",
  twErrLand:"Error en el aterrizaje",
  twBurstRange:"Reventado entre",
  twLegendErr:"Segmento naranja: dónde cae con el reventado más bajo y más alto.",
  twEvery:"Cada",
  twToTime:"Hasta la hora",
  twToDay:"Hasta el día",
  twMulti:"Varias partidas",
  twHand:"a mano",
  twStart:"Partida",
  twGround:"{m} m s.n.m. (altura del terreno)",
  twWHeavy:"La carga es demasiado pesada: con este globo no se sube a esta velocidad.",
  twWPay:"La carga supera el máximo nominal del globo ({max} g).",
  twWBurst:"Parámetros incompatibles: el globo reventaría por debajo de 30 km. Es demasiado chico para esta carga y este ascenso.",
  twWSlow:"Ascenso por debajo de 3 m/s: vuelo largo, deriva amplia, riesgo de que el globo flote sin reventar.",
  twWDesc:"Descenso al suelo demasiado rápido ({v} m/s): por encima de 6 m/s el golpe puede dañar la sonda. Para 5 m/s hace falta un paracaídas de al menos {d} m.",
  twWBad:"Parámetros incompletos o incompatibles: revisá los valores del globo.",
  ...
  lClassOut:"La sonda Klo-01 es un globo <strong>«ligero»</strong>: pesa poco más de un tercio del umbral de 4 kg, el bulto es único y muy por debajo de 3 kg, su densidad es casi cuatro veces menor que el límite, y el cordaje se corta antes de los 230 N. Este último criterio es necesario para que, en caso de choque con una aeronave, el globo se separe de la sonda.",
  ...
  msNot1:"<strong>El ozono y los óxidos de nitrógeno.</strong> Los sensores disponibles a este costo están calibrados para aire a nivel del mar; a las presiones de la estratósfera su respuesta no es interpretable, y no existe una forma practicable de calibrarlos para esas condiciones. Incluyendo estos sensores habríamos obtenido números imposibles de interpretar.",
  ...
  pg6t:"Pedido del material", pg6:"No fue un solo pedido. El material de vuelo — globo, paracaídas, caja, cámara y los dos rastreadores — viene de StratoFlights y ya está acá. El helio, que se compra en Uruguay, también llegó: un tubo de 40 litros a unos 200 bar, es decir 8,3 m³ de gas. Es helio de pureza 5.0, o sea 99,999 %. Los sensores y la electrónica están pedidos y los estamos esperando.",
  ...
  q3:"El récord para un globo no tripulado es de unos 53 km, logrado en Japón en 2013 con una película finísima y una carga mínima. Pero ese récord es de un tipo de globo distinto al nuestro. Los nuestros son <em>elásticos</em>: se inflan hasta que el látex cede, y ahí termina el vuelo. Los de récord son de <em>volumen constante</em>, inflados sólo en parte al partir, y se detienen cuando el aire alrededor se vuelve tan tenue como el gas que llevan dentro. Y ése es el límite verdadero, para todos: se sube mientras haya aire más denso que el gas del globo. Cuando ya no lo hay, no hay empuje, independientemente de la cantidad de helio.",
...
en:{
  ...
  wKicker:"Phase 1 · Trajectory", windsTitle:"Where the probe ends up",
  windsSub:"A tool to forecast the flight in the days before the launch, and the study we used to choose where to launch from.",
  ...
  wStagQ:"As mentioned above, between September and November the model has the stratosphere warm and expand, and the burst altitude rises accordingly. This is not a result of the simulation: it is the phenomenon the simulation accounts for, day by day, over the period that matters to us.",
  ...
  mapHint:"Clicking a dot shows the date of that flight.",
  wParH:"The calculation parameters",
  ...
  /* — Forecast for the day (Tawhiri) — */
  twHead:"Forecasting the flight",
  twP1:"The script works out the vertical dynamics of the balloon — ascent, burst and descent — and the trajectory.",
  twP1c:"The trajectory is computed by <strong>Tawhiri</strong>, the balloon trajectory predictor run by SondeHub, through the winds of the latest forecast of NOAA's global <strong>GFS</strong> model, which is rerun every six hours.",
  twP1b:"For the physics of the balloon we use an atmospheric model that is different every day. The temperature and height of the pressure levels come from weather data up to <strong>24 km</strong>, and above that from a model that accounts for latitude and season — between September and November the stratosphere warms and expands, which affects the burst altitude.",
  twP2:"Tawhiri only works out where the wind carries the balloon: the burst altitude and the descent rate come from us, from the same balloon model used in the study below. The forecast covers about <strong>a week</strong>, and the closer the day, the more reliable it is.",
  twDate:"Day", twTime:"Launch time (Uruguay)", twAsc:"Ascent · m/s", twBurst:"Burst · km", twDesc:"Descent at ground · m/s",
  twRun:"Compute the trajectory", twWeek:"Compare the next days",
  twLoading:"Computing…", twDone:"GFS forecast of {run}, Uruguay time.",
  twErr:"Tawhiri did not answer: {msg}", twNoNet:"the service cannot be reached, try again in a few minutes.",
  twBad:"Check the values: ascent between 1 and 10 m/s, burst between 10 and 45 km, descent between 1 and 15 m/s.",
  twLand:"Landing", twDrift:"Drift", twBear:"Bearing", twDur:"Flight time", twAt:"Touches down at", twBurstDist:"Burst at",
  twMaps:"Open the point in Google Maps",
  twOk:"Outside the exclusion area", twEscl:"Inside the exclusion area", twFuori:"Outside Uruguay",
  twLegend:"Star: launch · solid line: ascent · dashed: descent · white circle: burst.",
  twWDay:"Day", twWeekNote:"Same place, same time and same balloon for every day. Click a row to show that forecast on the map.",
  twNote:"The exclusion area is the approximate polygon also used in the study.",
  srcTw:"<strong>Forecast for the day:</strong> the Tawhiri predictor by <a href=\"https://sondehub.org/\" target=\"_blank\" rel=\"noopener\">SondeHub</a>, on the winds of the GFS model by <a href=\"https://www.noaa.gov/\" target=\"_blank\" rel=\"noopener\">NOAA</a>; atmosphere of the day from the Open-Meteo Forecast API and, above 24 km, from NRLMSIS 2.1.",
  vStudyHead:"The wind study",
  vIdxCalc:"How it is computed",
  twGStart:"Launch",
  twWhere:"Launch site",
  twWherePh:"Place or coordinates",
  twWhereHint:"Type the name of a place or the coordinates (for example -33.38, -56.52), or tap the map.",
  twGeo:"Use my location",
  twGeoErr:"Location not available.",
  twGeoWait:"Finding your location…",
  twGeoDenied:"The browser is not allowed to use your location: enable it in the site settings.",
  twNoPlace:"Choose the launch site first.",
  twStudied:"site of the study",
  twNoRes:"No place found.",
  twPoint:"Point on the map",
  twGBalloon:"Balloon",
  twBalloon:"Model",
  twDiam:"Burst Ø · m",
  twMass:"Balloon mass · kg",
  twPayload:"Payload · kg",
  twChute:"Parachute Ø · m",
  twHe:"Helium needed",
  twNeck:"Neck lift",
  twBurstC:"Burst altitude",
  twDescC:"Descent at ground",
  twIsa:"The burst altitude is computed with the atmosphere forecast for the launch site, day and time; if those data are not available, with the standard atmosphere (ISA). The cylinder is taken at 200 bar, unless the gauge reading is set by hand, and at 15 °C, allowing for the fact that at such pressures helium does not behave as an ideal gas. Unless set by hand, the parachute is the one in the kit: 1.2 m in diameter, drag coefficient 1.0, mass 80 g.",
  twTBurst:"Time to burst",
  twPCyl:"Cylinder pressure · bar",
  twWCyl:"The cylinder is not enough: {v} m³ of helium are needed and it holds about {c}.",
  twCylLeft:"cylinder at 15 °C",
  twCyl:"Cylinder",
  twCardHand:"Burst altitude set by hand.",
  twCardStd:"Burst altitude computed with the standard atmosphere: the data for the day were not available.",
  twCardDay:"Burst altitude computed with the atmosphere forecast for that day and time.",
  twAtmoStd:"standard atmosphere",
  twAtmoDay:"atmosphere of the day",
  twManual:"Advanced settings",
  twManHint:"Left empty, the chosen model's data and the computed values apply.",
  twLegendBand:"Star: launch · band: the trajectories of all launches · orange: the landing zone.",
  twMapsMid:"Open the mean point in Google Maps",
  twSpreadV:"within {d} km of the mean point",
  twSpread:"Landings",
  twLandMid:"Mean landing",
  twOfN:"{k} of {n}",
  twNFlights:"Launches computed",
  twProgress:"Computing… {i} of {n}",
  twTooMany:"Too many launches ({n}): at most {m}. Shorten the interval or lengthen the step.",
  twBadRange:"Check the launches: the final day and time must come after the initial ones.",
  twMultiHint:"From the day and time chosen above up to these. Left empty, a single launch is computed.",
  twErrH:"Landing error",
  twErrOn:"Compute the error",
  twErrSig:"Burst diameter · ± %",
  twErrHint:"The burst altitude is the main source of error: it depends on the diameter at which the latex gives way, which varies from one balloon to another. The trajectory is recomputed with the lowest and highest burst. Single launch only.",
  twErrLand:"Landing error",
  twBurstRange:"Burst between",
  twLegendErr:"Orange segment: where it lands with the lowest and highest burst.",
  twEvery:"Every",
  twToTime:"Until time",
  twToDay:"Until day",
  twMulti:"Several launches",
  twHand:"by hand",
  twStart:"Launch",
  twGround:"{m} m a.s.l. (ground elevation)",
  twWHeavy:"The payload is too heavy: this balloon cannot climb at this rate.",
  twWPay:"The payload exceeds the balloon's nominal maximum ({max} g).",
  twWBurst:"Incompatible parameters: the balloon would burst below 30 km. It is too small for this payload and ascent rate.",
  twWSlow:"Ascent below 3 m/s: long flight, wide drift, risk that the balloon floats without bursting.",
  twWDesc:"Descent at ground too fast ({v} m/s): above 6 m/s the impact may damage the probe. For 5 m/s you need a parachute of at least {d} m.",
  twWBad:"Incomplete or incompatible parameters: check the balloon values.",
  ...
  lClassOut:"The Klo-01 probe is a <strong>«light»</strong> balloon: it weighs a little over a third of the 4 kg threshold, it is a single package well under 3 kg, its density is almost four times below the limit, and the cord breaks before 230 N. This last criterion is needed so that, in a collision with an aircraft, the balloon separates from the probe.",
  ...
  msNot1:"<strong>Ozone and nitrogen oxides.</strong> The sensors available at this price are calibrated for air at sea level; at stratospheric pressures their response cannot be interpreted, and there is no practical way to calibrate them for those conditions. Fitting these sensors would have given us numbers that are impossible to interpret.",
  ...
  orgDiscord:"The teams coordinate on a Discord server: one channel for official announcements, one per team, one where progress is logged and one for technical questions, open to everyone, while the coordinators have one of their own. The rule is: if it is not on the Discord server, it does not exist.",
