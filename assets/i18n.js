...
it:{
  ...
  twWVel:"Velocità di salita fuori dall'intervallo consigliato per questo pallone ({a}-{b} m/s).",
  twWHe:"L'elio necessario supera quello disponibile.",
  twWBurst:"Quota di scoppio bassa: meno di 30 km.",
  twWSlow:"Salita sotto i 3 m/s: volo lungo, deriva ampia, rischio che il pallone galleggi senza scoppiare.",
  twWFast:"Salita sopra i 6 m/s: si spreca elio e lo scoppio avviene più in basso.",
...
es:{
  ...
  twWVel:"Velocidad de ascenso fuera del intervalo recomendado para este globo ({a}-{b} m/s).",
  twWHe:"El helio necesario supera el disponible.",
  twWBurst:"Altura de reventado baja: menos de 30 km.",
  twWSlow:"Ascenso por debajo de 3 m/s: vuelo largo, deriva amplia, riesgo de que el globo flote sin reventar.",
  twWFast:"Ascenso por encima de 6 m/s: se desperdicia helio y el reventado ocurre más abajo.",
...
en:{
  ...
  twWVel:"Ascent rate outside the range recommended for this balloon ({a}-{b} m/s).",
  twWHe:"The helium needed exceeds the helium available.",
  twWBurst:"Low burst altitude: below 30 km.",
  twWSlow:"Ascent below 3 m/s: long flight, wide drift, risk that the balloon floats without bursting.",
  twWFast:"Ascent above 6 m/s: helium is wasted and the balloon bursts lower.",
