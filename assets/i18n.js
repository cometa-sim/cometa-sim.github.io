...
it:{
  ...
  twIsa:"La quota di scoppio è calcolata con l'atmosfera prevista per il luogo, il giorno e l'ora della partenza; se quei dati non arrivano, con l'atmosfera standard (ISA). Il paracadute ha coefficiente di resistenza 1,0 e massa 80 g, come quello del kit.",
...
es:{
  ...
  twIsa:"La altura de reventado se calcula con la atmósfera pronosticada para el lugar, el día y la hora de partida; si esos datos no llegan, con la atmósfera estándar (ISA). El paracaídas tiene coeficiente de resistencia 1,0 y masa 80 g, como el del kit.",
...
en:{
  ...
  twIsa:"The burst altitude is computed with the atmosphere forecast for the launch site, day and time; if those data are not available, with the standard atmosphere (ISA). The parachute has a drag coefficient of 1.0 and a mass of 80 g, like the one in the kit.",
